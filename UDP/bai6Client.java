    ...
    public static void main(String[] args) {
        try {
            ...
            while (true) {
                ...
                DatagramPacket in = new DatagramPacket(ghi, ghi.length,InetAddress.getByName("localhost"),6789);
                ...
                in = new DatagramPacket(ghi, ghi.length,InetAddress.getByName("localhost"),6789);
                ds.send(in);
                //nhan kq tu server
